...
function gerarobstaculos(){
  ...
  if(frameCount % 120 == 0){
    obstaculos = createSprite (620,380);
...
function setup(){
  ...
  //trex criçao
  trex = createSprite(95,190,10,10);
  ...
  //chao criaçao
  solo = createSprite(300,490,100,10);
  solo.addImage ("solo", chao)
  solo.height = 60
  solo.depth = 1;
  
  //solo invisivel
  soloinvisivel = createSprite (300,420,600,10);
  ...
  //fim de jogo
  fimdejogo = createSprite(325,150,0,0);
  fimdejogo.addImage("perdedor", gameover);
  fimdejogo.visible = false;
  
  botaoreiniciar = createSprite(325,250,0,0);
